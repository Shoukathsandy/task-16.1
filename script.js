var container=document.createElement('div');
 ...
 var h1=createtag("h1","title","Form Submission");
...
var formdiv9=createformdiv("form-check")
var formdiv10=createformdiv("form-check")
var formdiv11=createformdiv("form-check")
var formdiv12=createformdiv("form-check ")
var formdiv13=createformdiv("form-check")
...
var foodlistLabel=label("foodlist","Choice of Foods :");
 var food1label=label("food1","SouthIndian");
 var food2label=label("food2","NorthIndian");
 var food3label=label("food3","Chinese");
 var food4label=label("food4","TamilNadu");
 var food5label=label("food5","Japanese");
...
var food1name=food("input","checkbox","food","food1","SouthIndian","form-check-input" )
var food2name=food("input","checkbox","food","food2","NorthIndian","form-check-input" )
var food3name=food("input","checkbox","food","food3","Chinese","form-check-input" )
var food4name=food("input","checkbox","food","food4","TamilNadu","form-check-input" )
var food5name=food("input","checkbox","food","food5","Japanese","form-check-input" )
...
var p=createtag("h1","title","Temporary Database");
